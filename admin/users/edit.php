        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col mt-4">
                    ...
                    <input name="login" value="<?=$username?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="Введіть логін...">
                </div>
                <div class="mb-3 col-12 col-md-4">
                    <label for="exampleInputEmail1" class="form-label">Пошта</label>
                    <input readonly name="email" value="<?=$user['email']?>"  type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Введіть пошту...">
                </div>
                <div class="col">
                    <label for="exampleInputPassword1" class="form-label">Оновити пароль</label>
                ...
                <div class="col">
                    <button name="update-user" class="btn btn-primary mt-4" type="submit">Оновити</button>
                </div>
            </form>
        </div>
    </div>
