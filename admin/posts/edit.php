    ...
    <div class="posts col-9">
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col mb-4">
                    <input value="<?=$post['title'];?>"  name="title" type="text" class="form-control" placeholder="Title" aria-label="name">
                </div>


                <div class="col">
                    <label for="editor" class="form-label">Содержание записи</label>
                    <textarea name="content" id="editor" class="form-control" rows="3"><?=$post['content'];?></textarea>
                </div>
